            ...
            <div className="projectsWrap">
                ...
                <div style={{ padding: '3%', borderRadius: '4%', backgroundColor: 'white', float: 'left', width: '80%', marginLeft: '10%', height: 'auto', textAlign: 'center' }}>
                    ...
                    <div className="projectDesc">
                        이 프로젝트는 <strong>현재 많은 사람들이 이용하는 쿠팡을 벤치마킹해서 최근 현업에서도 많이 쓰이는 React와 JPA를 이용하고 SPA(Single Page Application)에 집중해서 구현한 프로젝트</strong> 입니다. 
                        비트캠프 학원에서 팀을 이뤄 7명의 팀원과 함께 <span>소통하며 협업</span>하는 방법도 배울 수 있었던 유익한 프로젝트였습니다. 특히 백엔드 개발자와 협업하는
                        과정에 대해서 많이 배울 수 있었던 프로젝트였고 소통방법은 <span>API 명세</span>를 문서로 작성하여 소통하였습니다. API는 restful API였고 사용하는데 더욱 익숙해질 수 있었습니다. 소통하기위한 툴은 <span>Notion, Github, Slack</span> 입니다.
